...
def morti():
    ...
    lbl_scatter = "{}: {}".format(date[-1].strftime("%d-%h"), int(raggruppati['deceduti'].diff().tail(1).values[0]))
    plt.plot(date, raggruppati['ma'], color = "#464646", alpha = 1, linewidth =2, label = "weekly avg.")
    plt.scatter(x = date[-1], y = raggruppati['deceduti'].diff().tail(1), color = "#464646", alpha = 1, label = lbl_scatter)
    ...
    ax.legend()
    plt.grid(alpha = 0.5)
    plt.savefig("pics/morti/italia.png", dpi = 100, bbox_inches='tight')
    plt.close(fig)
    ...
    for regione in dati_regione['denominazione_regione'].unique():
        ...
        y = ax.lines[-1].get_ydata()
        ax.fill_between(x, 0, y, color='#464646', alpha=0.2)
        plt.plot(date, pos_ma_regioni, color = "#464646", alpha = 1, linewidth =2, label = 'weekly avg.')
        lbl_scatter = "{}: {}".format(date[-1].strftime("%d-%h"), int(per_regioni.diff().tail(1).values[0]))
        plt.scatter(x = date[-1], y = per_regioni.diff().tail(1), color = "#464646", alpha = 1, label = lbl_scatter)
        ...
        plt.grid(alpha = 0.5)
        ax.legend()
        fig.savefig("pics/morti/{}.png".format(regione.lower()), dpi = 100, bbox_inches='tight')
        plt.close(fig)
    ...
    y = ax.lines[-1].get_ydata()
    ax.fill_between(x, 0, y, color='#464646', alpha=0.2)
    plt.plot(date[-30:], raggruppati['ma'][-30:], color = "#464646", alpha = 1, linewidth =2, label = 'weekly avg.')
    lbl_scatter = "{}: {}".format(date[-1].strftime("%d-%h"), int(raggruppati['deceduti'].diff().tail(1).values[0]))
    plt.scatter(x = date[-1], y = raggruppati['deceduti'].diff().tail(1), color = "#464646", alpha = 1, label = lbl_scatter)
    ...
    ax.legend()
    plt.grid(alpha = 0.5)
    plt.savefig("pics/morti_news/italia.png", dpi = 100, bbox_inches='tight')
    plt.close(fig)
    ...
    for regione in dati_regione['denominazione_regione'].unique():
        ...
        y = ax.lines[-1].get_ydata()
        ax.fill_between(x, 0, y, color='#464646', alpha=0.2)
        plt.plot(date[-30:], pos_ma_regioni[-30:], color = "#464646", alpha = 1, linewidth =2, label = 'weekly avg.')
        lbl_scatter = "{}: {}".format(date[-1].strftime("%d-%h"), int(per_regioni.diff().tail(1).values[0]))
        plt.scatter(x = date[-1], y = per_regioni.diff().tail(1), color = "#464646", alpha = 1, label = lbl_scatter)
        ...
        plt.grid(alpha = 0.5)
        ax.legend()
        fig.savefig("pics/morti_news/{}.png".format(regione.lower()), dpi = 100, bbox_inches='tight')
        plt.close(fig)